...
const Question = () => {
    return (
       <>
            <h1 className='font-extrabold text-center text-4xl mt-6 p-4 text-orange-500 shadow-xl rounded w-5/6 mx-auto'>Important Blogs Here</h1>
             <div className='w-5/6 mx-auto pt-6 grid grid-cols-1 md:grid-cols-2 md:gap-4 mb-6'>
                <div className='bg-base-100 shadow-xl rounded p-4 my-4'>
                    <h3 className='text-center p-4 font-bold text-primary '>Difference between props and state.</h3>
                ...
                <div className='bg-base-100 shadow-xl rounded p-4 my-4'>
                    <h3 className='text-center p-4 font-bold text-primary'>How does useState work?</h3>
                ...
                <div className='bg-base-100 shadow-xl rounded p-4 my-4'>
                    <h3 className='text-center p-4 font-bold text-primary'>Purpose of useEffect other than fetching data.</h3>
                ...
                <div className='bg-base-100 shadow-xl rounded p-4 my-4'>
                    <h3 className='text-center p-4 font-bold text-primary'>How does react work?</h3>
